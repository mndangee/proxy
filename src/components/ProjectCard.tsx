  ...
  return (
    <article className="rounded-4 border-border-enabled bg-background-white flex flex-col border p-5 shadow-sm transition-shadow hover:shadow-md">
      <div className="flex items-start justify-end">
        <button type="button" className="text-label-assistant rounded p-1 hover:text-orange-500" aria-label={project.isFavorite ? "Remove from favorites" : "Add to favorites"}>
          {project.isFavorite ? (
      ...
      <div className="mt-auto flex items-center justify-between pt-4">
        ...
        <button type="button" className="text-label-assistant hover:text-label-neutral rounded p-1 hover:bg-gray-200" aria-label="Delete project">
          <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
