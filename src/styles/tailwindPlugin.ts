...
const addPrefix = (data: Record<string, unknown>, prefix: string) => {
  for (const property in data) {
    delete Object.assign(data, { [`.${prefix}-${property}`]: data[property] })[property];
  }
};

const lineHeight: Record<string, { lineHeight: string }> = {
...
const fontSize: Record<string, { fontSize: string }> = {
...
const typo: Record<string, ReturnType<typeof apply>> = {
...
const cn: Record<string, ReturnType<typeof apply>> = {
...
addPrefix(typo as Record<string, unknown>, "typo");
addPrefix(cn as Record<string, unknown>, "cn");
addPrefix(lineHeight as Record<string, unknown>, "line-height");
addPrefix(fontSize as Record<string, unknown>, "font-size");
